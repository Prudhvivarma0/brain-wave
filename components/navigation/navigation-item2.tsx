...
export const NavigationItem = ({
    ...
    return (
        ...
        >
            <div className="flex h-[70px] w-full rounded-[18px] group-hover:rounded-[16px] transition-all overflow-hidden items-center justify-right bg-[#a733b9] group-hover:bg-[#b539cb] ">
        ...
        <button className="group relative flex flex-col items-right gap-y-3 w-full max-w-[100px]">
            <div className="flex h-[70px] w-full rounded-[18px]  transition-all overflow-hidden items-center justify-center bg-[#a733b9] ">
